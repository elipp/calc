...
{ "sin(0.3*pi^3)^3*2  / 31.31+531*(-999*33.25/833-1*e*log(20/tan(20)) - (e/pi+1)^2/3.33)/(301.3+53*sin(31*cos(445)))", -65.4999835337342775L },

{ "(sin(0.3*pi^3)^3*2  / 31.31+531*(-999*33.25/833-1*e*log(20/tan(20)) - (e/pi+1)^2/3.33)/(301.3+53*sin(31*cos(445))))\
- (sin(0.3*pi^3)^3*2  / 31.31+531*(-999*33.25/833-1*e*log(20/tan(20)) - (e/pi+1)^2/3.33)/(301.3+53*(sin(31*cos(445)))))\
+ (sin(0.3*pi^3)^3*2  / 31.31+531*(-999*33.25/833-1*e*log(20/tan(20)) - (e/pi+1)^2/3.33)/(301.3+53*(sin(31*cos(445)))))\
- (sin(0.3*pi^3)^3*2  / 31.31+531*(-999*33.25/833-1*e*log(20/tan(20)) - (e/pi+1)^2/3.33)/(301.3+53*(sin(31*cos(445)))))\
+ (sin(0.3*pi^3)^3*2  / 31.31+531*(-999*33.25/833-1*e*log(20/tan(20)) - (e/pi+1)^2/3.33)/(301.3+53*(sin(31*cos(445)))))\
...
- (sin(0.3*pi^3)^3*2  / 31.31+531*(-999*33.25/833-1*e*log(20/tan(20)) - (e/pi+1)^2/3.33)/(301.3+53*(sin(31*cos(445)))))\
+ (sin(0.3*pi^3)^3*2  / 31.31+531*(-999*33.25/833-1*e*log(20/tan(20)) - (e/pi+1)^2/3.33)/(301.3+53*(sin(31*cos(445)))))\
- (sin(0.3*pi^3)^3*2  / 31.31+531*(-999*33.25/833-1*e*log(20/tan(20)) - (e/pi+1)^2/3.33)/(301.3+53*(sin(31*cos(445)))))", 0.0L },
